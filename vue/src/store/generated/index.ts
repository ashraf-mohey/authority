...
import AshrafMoheyAuthorityAshrafmoheyAuthorityOrganization from './ashraf-mohey/authority/ashrafmohey.authority.organization'
import AshrafMoheyAuthorityAshrafmoheyAuthorityPatient from './ashraf-mohey/authority/ashrafmohey.authority.patient'
...
export default { 
  AshrafMoheyAuthorityAshrafmoheyAuthorityOrganization: load(AshrafMoheyAuthorityAshrafmoheyAuthorityOrganization, 'ashrafmohey.authority.organization'),
  AshrafMoheyAuthorityAshrafmoheyAuthorityPatient: load(AshrafMoheyAuthorityAshrafmoheyAuthorityPatient, 'ashrafmohey.authority.patient'),
