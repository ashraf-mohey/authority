...
func (k Keeper) GetPatients(goCtx context.Context, req *types.QueryGetPatientsRequest) (*types.QueryGetPatientsResponse, error) {
	if req == nil {
	...
	return &types.QueryGetPatientsResponse{Patients: patients, Pagination: pageRes}, nil
}
